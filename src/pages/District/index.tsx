...
export default function DistrictPage() {
  ...
  const { columns } = useColumnDistrict({
    currentPage, pageSize, onView: handleOpenView, onEdit: handleOpenEdit,
    onDelete: (id) => Modal.confirm({ title: "Xác nhận xóa?", onOk: () => handleDelete(id) }),
  });

  return (
    // Boilerplate Tailwind y hệt như Province!
    ...
    >
      <DistrictSearchForm onSearch={handleSearch} onImport={() => setModalImportOpen(true)} onCreate={handleOpenCreate} />
